...
namespace AspNet.Identity.Couchbase.Entities
{
        ...
        where TUser : global::Microsoft.AspNet.Identity.EntityFramework.IdentityUser
    {
        ...
        {
            get { return GetAllUsers().AsQueryable<TUser>(); }
        }
        ...
        public UserStore(CouchbaseDatabase database)
        {
            Database = database;
        ...
        {
            var request = QueryRequest.Create(String.Format("SELECT * FROM {0} WHERE  META({1}).id LIKE 'User_%'", Database.BucketName, Database.BucketName))
                                      .ScanConsistency(ScanConsistency.RequestPlus);
            return Database.MultiSelect<TUser>(request);
        }
        ...
        public Task<TUser> FindByIdAsync(string userId)
        {
            ...
            if (result != null) { return Task.FromResult<TUser>(result); }
        ...
        {
            userTable.SetPasswordHash(user, passwordHash);
            return Task.FromResult<Object>(null);
        }
        ...
        {
            userTable.SetSecurityStamp(user, stamp);
        ...
        public Task AddClaimAsync(TUser user, Claim claim)
        {
            ...
            userClaimsTable.Insert(claim, user);
            return Task.FromResult<object>(null);
        }
        ...
        {
            ClaimsIdentity identity = userClaimsTable.FindByUserId(user);
        ...
        public Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user)
        {
            ...
            {
                UserLoginInfo newLogin = new UserLoginInfo(login.LoginProvider, login.ProviderKey);
                logins.Add(newLogin);
            }
        ...
        public Task AddToRoleAsync(TUser user, string roleName)
        {
            ...
            string roleId = roleTable.GetRoleIdByName(roleName);
        ...
        public Task<IList<string>> GetRolesAsync(TUser user)
        {
            ...
            List<string> roles = userRolesTable.FindByUserId(user);
            {
                if (roles != null)
                {
        ...
        {
            userRolesTable.Delete(user, role);
            return Task.FromResult<object>(null);
        }
